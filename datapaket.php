...
curl_setopt_array($curl, array(
  ...
  CURLOPT_POSTFIELDS => "origin=160&destination=".$distrik."&weight=".$berat."&courier=".$ekspedisi,
  // CURLOPT_POSTFIELDS => "origin=419&destination=114&weight=1700&courier=jne",
  CURLOPT_HTTPHEADER => array(
    "content-type: application/x-www-form-urlencoded",
    "key: ca2f6304999c28714cdae98a5913fc74"
  ),
));
